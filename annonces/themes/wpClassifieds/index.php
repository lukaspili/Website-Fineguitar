...
if (isset($idItem)||isset($currentCategory)||isset($type)||cG("s")!=""||isset($location)){
?>
<div id="listings">
<?php 
...
<?php    
	 ...
	 <div class="new-Ads"><?php echo '<a title="'.T_("Publish a new Ad").'" href="'.SITE_URL.newURL().'">'.T_("Publish a new Ad").'</a>';?></div>
      <div id="carousel">
