...
?>
<ul>
    <li><a href="<?php echo SITE_URL;?>/adming2s/optimize.php?action=cache" onClick="return confirm('<?php _e("Are you sure");?>?');"><?php _e("Delete Cache");?></a></li>
    <li><a href="<?php echo SITE_URL;?>/adming2s/optimize.php?action=notconfirmed" onClick="return confirm('<?php _e("Are you sure");?>?');"><?php _e("Delete Ads not confirmed in 3 days");?></a></li>
    <li><a href="<?php echo SITE_URL;?>/adming2s/optimize.php?action=db" onClick="return confirm('<?php _e("Are you sure");?>?');"><?php _e("Optimize  all tables found in the database");?></a></li>
    <li><a href="<?php echo SITE_URL;?>/adming2s/phpinfo.php" ><?php _e("PHP Info")?></a></li>
</ul>
<?php
