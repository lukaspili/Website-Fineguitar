...
class PHPMailer {
  ...
  public $CharSet           = CHARSET;//using charset from OC settings
  ...
  public function WrapText($message, $length, $qp_mode = false) {
    ...
    // If utf-8 encoding is used, we will need to make sure we do not
    ...
    switch (strtolower($position)) {
      case 'phrase':
        if (!preg_match('/[\200-\377]/', $str)) {
          /* Can't use addslashes as we do not know what value has magic_quotes_sybase. */
  ...
  */
  ...
  public function MsgHTML($message,$basedir='') {
    ...
    if ( !empty($textMsg) && empty($this->AltBody) ) {
      ...
      $this->AltBody =htmlentities($textMsg, ENT_QUOTES, CHARSET);
    }
    if ( empty($this->AltBody) ) {
