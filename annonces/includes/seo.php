...
elseif(strpos($_SERVER["SCRIPT_NAME"], "terms-of-use.php")>0){
	$html_title.="Conditions d'utilisation".SEPARATOR.SITE_NAME;
	$html_description=$html_title;	
}
elseif(strpos($_SERVER["SCRIPT_NAME"], "about-us.php")>0){
	$html_title.="Qui sommes nous".SEPARATOR.SITE_NAME;
	$html_description=$html_title;	
}
elseif(strpos($_SERVER["SCRIPT_NAME"], "imprint.php")>0){
	$html_title.="Mentions légales".SEPARATOR.SITE_NAME;
	$html_description=$html_title;	
}else{
	$html_title.=SITE_NAME;
	$html_description=$html_title;
