...
$PrintTotal = '';
$PrintNbFam = '';
$ControlFamilles = mysql_query('SELECT famille.Id_famille, famille.Nom_famille, sous_famille.Id_sous_famille, sous_famille.Nom_sous_famille FROM famille LEFT JOIN sous_famille ON famille.Id_famille=sous_famille.IdRef_famille WHERE famille.Id_famille="2" ORDER BY Id_famille ASC, Id_sous_famille ASC');
